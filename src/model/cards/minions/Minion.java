...
public class Minion extends Card implements Cloneable {
	...
	private ImageIcon image;//assigning images
	...
	public Minion(String name, int manaCost, Rarity rarity, int attack, int maxHP, boolean taunt, boolean divine,
		...
		if(name.equals("Goldshire Footman"))
			image=new ImageIcon("Minions/footman.png");
		if(name.equals("Icehowl"))
			image=new ImageIcon("Minions/Icehowl.png");
		if(name.equals("Stonetusk Boar"))
			image=new ImageIcon("Minions/Stonetusk.png");
		if(name.equals("Bloodfen Raptor"))
			image=new ImageIcon("Minions/Bloodfen Raptor.png");
		if(name.equals("Frostwolf Grunt"))
			image=new ImageIcon("Minions/FrostWolf.png");
		if(name.equals("Wolfrider"))
			image=new ImageIcon("Minions/Wolfrider.png");
		if(name.equals("Chilwind Yeti"))
			image=new ImageIcon("Minions/ChillWind Yeti.png");
		if(name.equals("Boulderfist Ogre"))
			image=new ImageIcon("Minions/Boulderfist.png");
		if(name.equals("Core Hound"))
			image=new ImageIcon("Minions/core hound.png");
		if(name.equals("Argent Commander"))
			image=new ImageIcon("Minions/ArgentCommandor.png");
		if(name.equals("Sunwalker"))
			image=new ImageIcon("Minions/sunwalker.png");
		if(name.equals("Chromaggus"))
			image=new ImageIcon("Minions/Chromaggus.png");
		if(name.equals("The LichKing"))
			image=new ImageIcon("Minions/TheLichKing.png");
		if(name.equals("Colossus of the Moon"))
			image=new ImageIcon("Minions/clossus.png");
		if(name.equals("King Krush"))
			image=new ImageIcon("Minions/kingKrush.png");
		if(name.equals("Kalycgos"))
			image=new ImageIcon("Minions/KLAY.png");
		if(name.equals("Prophet Velen"))
			image=new ImageIcon("Minions/velen.png");
		if(name.equals("Tirion Fordring"))
			image=new ImageIcon("Minions/tirion.png");
		if(name.equals("Wilfred Fizzlebang"))
			image=new ImageIcon("Minions/wilfred.png");
		if(name.equals("Silver Hand Recruit"))
			image=new ImageIcon("Minions/silver.jpg");
		if(name.equals("Sheep"))
			image=new ImageIcon("Minions/sheep.jpg");
